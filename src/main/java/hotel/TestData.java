...
public class TestData { 
	...
	public void init() {
		...
		reservation1.setCode(AuxiliaryClass.AssignCode());
		reservation1.setDateTimeEntryT(java.sql.Timestamp.valueOf("2023-04-11 10:10:10"));
		reservation1.setDateTimeEntryS("11.04.2023. 10:10");
		reservation1.setDateTimeOutputT(java.sql.Timestamp.valueOf("2023-04-23 10:10:10"));
		reservation1.setDateTimeOutputS("23.04.2023. 10:10");
		...
		reservation3.setCode(AuxiliaryClass.AssignCode());
		reservation3.setDateTimeEntryT(java.sql.Timestamp.valueOf("2023-12-01 18:15:10"));
		reservation3.setDateTimeEntryS("01.12.2023. 18:15");
		reservation3.setDateTimeOutputT(java.sql.Timestamp.valueOf("2023-12-31 18:15:10"));
		reservation3.setDateTimeOutputS("31.12.2023. 18:15");
